...
::: {.callout-note}
This Notebook is used to run the full simulation for the case study discussed in the manuscript. The simulation takes several hours to run on a Mac Book Pro (13-inch, M1, 2020) with 16 GB memory.
:::
