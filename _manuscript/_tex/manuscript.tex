...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, coltitle=black, breakable, opacityback=0, bottomrule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-important-color!10!white, titlerule=0mm, rightrule=.15mm, toptitle=1mm, colback=white, leftrule=.75mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, opacitybacktitle=0.6, colframe=quarto-callout-important-color-frame, arc=.35mm, left=2mm]
...
application-specific, tailored data simulations in a later section.
