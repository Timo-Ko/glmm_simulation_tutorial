...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, arc=.35mm, colframe=quarto-callout-important-color-frame, toprule=.15mm, colback=white, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, bottomtitle=1mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-important-color!10!white, left=2mm, opacityback=0, rightrule=.15mm, breakable, coltitle=black, toptitle=1mm, titlerule=0mm, bottomrule=.15mm]
