...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, coltitle=black, opacityback=0, breakable, toptitle=1mm, colbacktitle=quarto-callout-important-color!10!white, toprule=.15mm, arc=.35mm, colback=white, bottomrule=.15mm, left=2mm, colframe=quarto-callout-important-color-frame, rightrule=.15mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, bottomtitle=1mm, titlerule=0mm]
