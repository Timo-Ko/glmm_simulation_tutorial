...
For simple statistical models, like t-tests, ANOVA, and linear regression, with common study designs (e.g., mean comparison between two groups), user-friendly software for a priori power analysis is readily available [@faulStatisticalPowerAnalyses2009]. 
