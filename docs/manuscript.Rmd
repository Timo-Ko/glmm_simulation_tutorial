...
set.seed(42)
knitr::opts_chunk$set(cache.extra = knitr::rand_seed, echo = TRUE, eval = FALSE, fig.keep = "high", dev = "jpeg")
```
...
The smallest width is observed for the first contrast where both underlying probabilities are close to 1.
The largest width is observed for the fourth contrast, where both underlying probabilities are closer to 0.5.
