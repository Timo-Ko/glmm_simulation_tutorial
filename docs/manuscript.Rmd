---
title             : "A Tutorial for Customized Power Simulation and Data Analysis using GLMM  - A Case Study for Human-AI Interaction Experiments"
...
abstract: |
  Human-AI Intercation experiments are becoming increasingly important. However, many studies are underpowered since researchers lack the tools to conduct power analyses and sample size simulations. In this work, we provide. By providing code in a case study, we equip scientists to simulate their own data and run analyses based on generalized linear mixed models (GLMM).
  
keywords          : "generalized linear mixed model, data simulation, sample size, power analysis, data analysis"
...
Bespoke power simulations play a critical role in human-AI interaction research, allowing researchers to tailor power estimation to the unique aspects of their experiments. The skills required to perform these simulations should be taught to Human-AI interaction researchers, fostering a deeper understanding of statistical power and enhancing research design. It is essential to bridge the gap between perceived and actual effort associated with bespoke power simulations and recognize their value as research contributions. By integrating bespoke power simulations with open science and preregistration practices, researchers can improve the robustness and transparency of their findings, advancing the field.
