...
Power analysis represents the act of calculating the statistical power for a given true effect and sample size. 
By running the calculation for a range of sample sizes, the required sample size to find an assumed true effect with desired statistical power can be determined.
