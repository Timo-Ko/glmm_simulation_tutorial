...
g(E(Y|\mathbf{X}=\mathbf{x},\mathbf{U}=\mathbf{u})) = \eta <!-- SG: Sorry for maybe a stupid question, but what does E stand for? and why are model parameters β mentioned but not in the equation?-->
